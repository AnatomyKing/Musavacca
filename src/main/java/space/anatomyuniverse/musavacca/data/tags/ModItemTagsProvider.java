    ...
    *///?}
    ...
    protected void addTags(
        ...
        tag(ItemTags.SWORDS)
                ...
                .add(key(
                        ModItems.IMBUED_POTASSIUM_SWORD
                ));

        tag(ItemTags.PICKAXES)
                .add(key(ModItems.POTASSIUM_PICKAXE))
                .add(key(
                        ModItems.IMBUED_POTASSIUM_PICKAXE
                ));

        tag(ItemTags.AXES)
                .add(key(ModItems.POTASSIUM_AXE))
                .add(key(
                        ModItems.IMBUED_POTASSIUM_AXE
                ));

        tag(ItemTags.SHOVELS)
                .add(key(ModItems.POTASSIUM_SHOVEL))
                .add(key(
                        ModItems.IMBUED_POTASSIUM_SHOVEL
                ));

        tag(ItemTags.HOES)
                .add(key(ModItems.POTASSIUM_HOE))
                .add(key(
                        ModItems.IMBUED_POTASSIUM_HOE
                ));
