    ...
    public static final class Entry {
        ...
        private Entry(Builder builder) {
            ...
            if (builder.generated) {
                this.models = List.of(Model.always(CrossModels.generated(builder.block, builder.generatedTextureConfig)));
        ...
        public static final class Builder {
            ...
            private Consumer<CrossTextures.Builder>
            ...
            /*
             * Generate one cross model for this block.
             *
             * Texture selection is configured separately through
             * .texture(...), so the intent stays visible in NewModelSets.
             */
            ...
            public Entry build() {
                ...
                if (generated && mode != Mode.MODELS) {
                    throw new IllegalStateException("Generated cross model must use MODELS mode");
                }
