// file: C:/mods/Musavacca/src/main/java/space/anatomyuniverse/musavacca/data/models/block/CubeFireBlock.java
...
public final class CubeFireBlock {
     ...
     * modelStem:
     *   Generated model ids:
     *   block/<modelStem>_floor0
     *   block/<modelStem>_floor1
     *   block/<modelStem>_side0
     *   block/<modelStem>_side1
     *   block/<modelStem>_side_alt0
     *   block/<modelStem>_side_alt1
     *   block/<modelStem>_up0
     *   block/<modelStem>_up1
     *   block/<modelStem>_up_alt0
     *   block/<modelStem>_up_alt1
     *
     * textureStem:
     *   Uses:
     *   assets/<ns>/textures/block/<textureStem>_0.png
     *   assets/<ns>/textures/block/<textureStem>_1.png
     *
     * parent ids:
     *   Full model ids like:
    ...
    public static void generate(BlockModelGenerators gen, Map<Block, Entry> entries) {
        ...
        entries.forEach((block, entry) -> {
            ...
            // floor when no side/up faces are active
