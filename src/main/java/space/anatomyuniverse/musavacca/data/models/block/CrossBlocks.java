...
public final class CrossBlocks {
    ...
    public record Entry(EngineBlockEntry data) {
        public static Entry cross(Block block) {
            return new Entry(EngineBlockEntry.models(block, EngineBlockModel.cross()));
        }

        public static Entry cross(Block block, String textureId) {
            return new Entry(EngineBlockEntry.models(block, EngineBlockModel.crossTexture(textureId)));
        }
    ...
    public record Model(String modelId, String textureId, Conditions conditions, boolean generateCrossModel) {
        public static Model cross() { return new Model(null, null, null, true); }
        public static Model cross(String textureId) { return new Model(null, textureId, null, true); }
        public static Model cross(String modelId, String textureId) { return new Model(modelId, textureId, null, true); }
        public static Model model(String modelId) { return new Model(modelId, null, null, false); }
        public static Model crossWhen(Conditions conditions) { return new Model(null, null, conditions, true); }
        public static Model crossWhen(String textureId, Conditions conditions) { return new Model(null, textureId, conditions, true); }
        public static Model crossWhen(String modelId, String textureId, Conditions conditions) { return new Model(modelId, textureId, conditions, true); }
        public static Model when(String modelId, Conditions conditions) { return new Model(modelId, null, conditions, false); }

        private EngineBlockModel toEngine() {
            return generateCrossModel
                    ? EngineBlockModel.crossModel(modelId, textureId, conditions)
